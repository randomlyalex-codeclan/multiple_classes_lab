...
class TestBus(unittest.TestCase):
    ...
    #@unittest.skip("Delete this line to run the test")
    def test_has_destinations(self):
        self.assertLess(0, len(self.bus.destinations))
    ...
    def test_can_pick_up_passenger(self):
        waverley_bus_stop = BusStop("Waverly Station")
        person = Person("Guido van Rossum", 64, waverley_bus_stop)
    ...
    def test_can_pick_up_passenger_from_bus_stop(self):
        waverley_bus_stop = BusStop("Waverly Station")
        person_1 = Person("Guido van Rossum", 64, waverley_bus_stop)
        person_2 = Person("Carol Willing", 50, waverley_bus_stop)
    ...
    @unittest.skip("Delete this line to run the test")
    def test_bus_at_bus_stop_at_haymarket(self):
        princes_street_bus_stop = BusStop("Princes Street")
        waverley_bus_stop = BusStop("Waverly Station")        
        person_1 = Person("Guido van Rossum", 64, waverley_bus_stop)
        person_2 = Person("Carol Willing", 50, princes_street_bus_stop)
